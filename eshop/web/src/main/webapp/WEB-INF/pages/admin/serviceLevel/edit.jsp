	...
	<jsp:body>
		<form action="./" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
               ...
               <div class="col-sm-10">
               	   <select class="form-control" name="serviceTypeId">
               	       <c:forEach items="${services }" var="s">
               	           <option <c:if test="${s.id eq t.serviceType.id }">selected="selected"</c:if> value="${s.id }">${s.name }</option>
               	       </c:forEach>
               	   </select>
               </div>
           </div>
           <div class="form-group">
               ...
               <div class="col-sm-10">
                   <input value="${t.price }" type="number" class="form-control" name="price" placeholder="please input number">
               </div>
           </div>
           <div class="form-group">
